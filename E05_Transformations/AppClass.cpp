...
void AppClass::InitVariables(void)
{
	...
	m_m4Cube = glm::scale(m_m4Cube, vector3(2));

	m_m4Cone = glm::translate(IDENTITY_M4, vector3(0, 2, 0));
	m_m4Cone = glm::scale(m_m4Cone, vector3(2));

	m_m4Cylinder = glm::translate(IDENTITY_M4, vector3(-2, 0, 0));
	m_m4Cylinder = glm::scale(m_m4Cylinder, vector3(2));

	m_m4Tube = glm::translate(IDENTITY_M4, vector3(0, -2, 0));
	m_m4Tube = glm::scale(m_m4Tube, vector3(2));

	m_m4Sphere = glm::translate(IDENTITY_M4, vector3(1, 2, 0));

	m_m4Torus = glm::translate(IDENTITY_M4, vector3());
	m_m4Torus = glm::scale(m_m4Torus, vector3(2));
}
